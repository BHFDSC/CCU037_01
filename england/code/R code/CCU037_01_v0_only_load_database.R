# This script extracts tables from Databricks with an ethicity field and saves in the format necessary for "CCU037_01_v1.R" and "CCU037_01_v1_see_differences_NAvsAZ_in_GDPPR.R"
# Author: Marta Pineda
