...
# 1.4.1 Asian subset
my_title <- expression(paste("SNOMED concepts with a minimum of one individual within the ", italic("Asian/Asian British") ))
pA<- ggplot(mydata[mydata$six_cat == "Asian or Asian British",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
( ppA = pA + labs(title=my_title, x="Frequency individuals (%)", y = "SNOMED concepts")+ theme(plot.title = element_text(vjust = 0)) )
...
# 1.4.2 Black subset
my_title <- expression(paste("SNOMED concepts with a minimum of one individual within the ", italic("Black/African/Caribbean/Black British") ))
...
# 1.4.3 Mixed subset
my_title <- expression(paste("SNOMED concepts with a minimum of one individual within the ", italic("Mixed") ))
...
my_title <- expression(paste("SNOMED concepts with a minimum of one individual within the ", italic("Other Ethnic Groups") ))
...
my_title <- expression(paste("SNOMED concepts with a minimum of one individual within the ", italic("Unknown") ))
...
# 1.4.6 White subset
my_title <- expression(paste("SNOMED concepts with a minimum of one individual within the ", italic("White") ))
...
#--------------------------------------------------------------------------------------------------#
# 1.7 Barplots: select the 3 most frequent SNOMED concepts in each Primary Code letter
#--------------------------------------------------------------------------------------------------#
mydata <- all_data
mydata = mydata[mydata$n != 0,]
...
my_title <- expression(paste("Top 3 SNOMED concepts in each NHS ethnicity codes within ", italic("Asian/Asian British") ))
pA<- ggplot(mydata[mydata$six_cat == "Asian or Asian British",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppA = pA + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts")+ theme(plot.title = element_text(vjust = 0)) 
...
my_title <- expression(paste("Top 3 SNOMED concepts in each NHS ethnicity codes within ", italic("Black/Black British") ))
pB<- ggplot(mydata[mydata$six_cat == "Black or Black British",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppB = pB + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts")+ theme(plot.title = element_text(vjust = 0)) 
...
# 1.7.3 Mixed subset
my_title <- expression(paste("Top 3 SNOMED concepts in each NHS ethnicity codes within ", italic("Mixed") ))
pM<- ggplot(mydata[mydata$six_cat == "Mixed",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppM = pM + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts") + theme(plot.title = element_text(vjust = 0))
...
my_title <- expression(paste("Top 3 SNOMED concepts in each NHS ethnicity codes within ", italic("Other Ethnic Groups") ))
pO<- ggplot(mydata[mydata$six_cat == "Other Ethnic Groups",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppO = pO + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts") + theme(plot.title = element_text(vjust = 0)) 
...
my_title <- expression(paste("Top 3 SNOMED concepts in each NHS ethnicity codes within ", italic("Unknown") ))
pU<- ggplot(mydata[mydata$six_cat == "Unknown",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppU = pU + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts") + theme(plot.title = element_text(vjust = 0))
...
# 1.7.6 White subset
my_title <- expression(paste("Top 3 SNOMED concepts in each NHS ethnicity codes within ", italic("White") ))
pW<- ggplot(mydata[mydata$six_cat == "White",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppW = pW + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts") + theme(plot.title = element_text(vjust = 0))
...
#--------------------------------------------------------------------------------------------------#
# 1.8 Barplots: select the 5 most frequent SNOMED concepts in each Primary Code letter
#--------------------------------------------------------------------------------------------------#
mydata <- all_data
mydata = mydata[mydata$n != 0,]
...
# 1.7.1 Asian subset
#x_legend <- (paste(PrimaryCode_concept$PrimaryCode[PrimaryCode_concept$PrimaryCode %in% A_char], PrimaryCode_concept$Concept[PrimaryCode_concept$PrimaryCode %in% A_char] ))
my_title <- expression(paste("Top 5 SNOMED concepts in each NHS ethnicity codes within ", italic("Asian/Asian British") ))
pA<- ggplot(mydata[mydata$six_cat == "Asian or Asian British",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppA = pA + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts",fill="NHS ethnicity codes")+ theme(plot.title = element_text(vjust = 0)) 
...
# 1.7.2 Black subset
#x_legend <- (paste(PrimaryCode_concept$PrimaryCode[PrimaryCode_concept$PrimaryCode %in% B_char], PrimaryCode_concept$Concept[PrimaryCode_concept$PrimaryCode %in% B_char] ))
my_title <- expression(paste("Top 5 SNOMED concepts in each NHS ethnicity category within ", italic("Black/African/Caribbean/Black British") ))
pB<- ggplot(mydata[mydata$six_cat == "Black or Black British",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppB = pB + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts",fill="NHS ethnicity codes")+ theme(plot.title = element_text(vjust = 0)) 
...
# 1.7.3 Mixed subset
my_title <- expression(paste("Top 5 SNOMED concepts in each NHS ethnicity category within ", italic("Mixed") ))
pM<- ggplot(mydata[mydata$six_cat == "Mixed",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppM = pM + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts",fill="NHS ethnicity codes") + theme(plot.title = element_text(vjust = 0))
...
# 1.7.4 Other Ethnic Groups subset
my_title <- expression(paste("Top 5 SNOMED concepts in each NHS ethnicity category within ", italic("Other Ethnic Groups") ))
pO<- ggplot(mydata[mydata$six_cat == "Other Ethnic Groups",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppO = pO + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts",fill="NHS ethnicity codes") + theme(plot.title = element_text(vjust = 0)) 
...
# 1.7.5 Unknown subset
my_title <- expression(paste("Top 5 SNOMED concepts in each NHS ethnicity category within ", italic("Unknown") ))
pU<- ggplot(mydata[mydata$six_cat == "Unknown",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppU = pU + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts",fill="NHS ethnicity codes") + theme(plot.title = element_text(vjust = 0))
...
# 1.7.6 White subset
my_title <- expression(paste("Top 5 SNOMED concepts in each NHS ethnicity category within ", italic("White") ))
pW<- ggplot(mydata[mydata$six_cat == "White",], aes(x=snomed_all , y=SNOMED_ord, fill=PrimaryCode))+
	     geom_bar(stat="identity", width=0.7)+
	     theme_minimal()
ppW = pW + labs(title=my_title, x="Frequency of individuals in GDPPR (%)", y = "SNOMED concepts",fill="NHS ethnicity codes") + theme(plot.title = element_text(vjust = 0))
