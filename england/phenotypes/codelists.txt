...
#Cancer
#spark.sql(f"""
  CREATE OR REPLACE GLOBAL TEMP VIEW {project_prefix}_cancer_codelist AS
  SELECT DISTINCT code as code, term as term, terminology as system, "cancer" as codelist
...
spark.sql(f"""
  CREATE OR REPLACE GLOBAL TEMP VIEW {project_prefix}_AMI_codelist AS
  SELECT DISTINCT code as code, term as term, terminology as system, "AMI" as codelist
  FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127 
  WHERE name == 'AMI'
  """)
...
spark.sql(f"""
  CREATE OR REPLACE GLOBAL TEMP VIEW {project_prefix}_COPD_codelist AS
  SELECT DISTINCT code as code, term as term, terminology as system, "COPD" as codelist
  FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127 
  WHERE name == 'COPD'
  """)
#DVT - Deep vein thrombosis (in bhf_..._phenotypes_20210127 as DVT_DVT)
spark.sql(f"""
  CREATE OR REPLACE GLOBAL TEMP VIEW {project_prefix}_DVT_codelist AS
  SELECT DISTINCT code as code, term as term, terminology as system, "DVT" as codelist
  FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127 
  WHERE name == 'DVT_DVT'
  """)
#HF - Heart failure
spark.sql(f"""
  CREATE OR REPLACE GLOBAL TEMP VIEW {project_prefix}_HF_codelist AS
  SELECT DISTINCT code as code, term as term, terminology as system, "HF" as codelist
  FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127 
  WHERE name == 'HF'
  """)
...
spark.sql(f"""
  ...
  SELECT DISTINCT code as code, term as term, terminology as system, "PE" as codelist
  FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127 
  WHERE name == 'PE'
  """)
Dementia (not dementia_vascular)
FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127

#dementia
spark.sql(f"""
  CREATE OR REPLACE GLOBAL TEMP VIEW {project_prefix}_dementia_codelist AS
  SELECT DISTINCT code as code, term as term, terminology as system, "dementia" as codelist
  FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127 
  WHERE name == 'dementia'
  """)
...
spark.sql(f"""
  ...
  SELECT DISTINCT code as code, term as term, terminology as system, "diabetes" as codelist
  FROM bhf_cvd_covid_uk_byod.bhf_covid_uk_phenotypes_20210127 
  WHERE name == 'diabetes'
  """)
...
#stroke - _HS = haemmorhagic, _IS = ischaemic, _NOS = unspecified, SAH =  subarachnoid hemorrhage, TIA = Transient ischaemic attack.
spark.sql(f"""
